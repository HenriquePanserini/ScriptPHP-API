...
$sql = "INSERT INTO tslv021(cupom,codprod,descricao,quant,unit,desconto,preco1,total,unidade) VALUES ('$cupom','$codprod','$descricao','$quant','$unit','$desconto','$preco1','$total','$uni')";
