...
$sql = "INSERT INTO tslor01(data,codcli,bruto,desconto,liquido,codven,codform,codapp,dataincapp,datasincapp,tipopgto) VALUES ('$data','$codcli','$bruto','$desconto','$liquido','$codven','$codform','$codapp','$dataincapp','$datasincapp','$tipopgto')";
